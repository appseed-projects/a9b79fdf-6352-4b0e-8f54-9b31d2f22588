...
- Timestamp: `2022-05-30 01:45`
- Build ID: `a9b79fdf-6352-4b0e-8f54-9b31d2f22588`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/a9b79fdf-6352-4b0e-8f54-9b31d2f22588.git
$ cd a9b79fdf-6352-4b0e-8f54-9b31d2f22588
```
